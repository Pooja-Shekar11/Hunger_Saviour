...
public class ResturantOneMenus extends AppCompatActivity {

    RecyclerView recyclerView;
    FirebaseRecyclerOptions<Menus> options;
    FirebaseRecyclerAdapter<Menus,MyViewHolder>adapter;
    DatabaseReference DataRef;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_resturant_one_menus);
        DataRef=FirebaseDatabase.getInstance().getReference("McDonalds").child("mcdmenu");
    ...
    private void LoadData() {
        ...
        adapter=new FirebaseRecyclerAdapter<Menus, MyViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int position, @NonNull Menus model) {
                ...
                myViewHolder.v.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent i = new Intent(ResturantOneMenus.this,FoodDetails.class);
                        i.putExtra("Foodkey",getRef(position).getKey());
                        startActivity(i);
                    }
                });
            }
